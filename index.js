///Spanish: Hola chicos, hoy les traigo un bot simple con algunos comandos////
///English: Hi guys, today I bring you a simple bot with some commands////
...
client.once('ready', () => {
    ...
    client.user.setActivity('YOUR PRESENCE / (TU PRESENCIA)', {
        type: "WATCHING"
    });
});
